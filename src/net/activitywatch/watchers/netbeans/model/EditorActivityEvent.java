...
public class EditorActivityEvent
{
    ...
    {
        return "EditorActivityEvent{" + "file=" + file + ", project=" + project + ", projectPath=" + projectPath + ", language=" + language + ", editor=" + editor + ", editorVersion=" + editorVersion + ", eventType=" + eventType + '}';
    }
